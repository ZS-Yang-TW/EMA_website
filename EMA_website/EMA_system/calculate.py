...
def calculate_str(a, b):
    ...
    return a_str_list, b_str_list, ans_str_list, carry_str_list, max_len
    
if __name__ == '__main__':
    a_str_list, b_str_list, ans_str_list, carry_str_list, max_len = calculate_str(999,9)
    print(a_str_list, b_str_list, ans_str_list, carry_str_list, max_len)
